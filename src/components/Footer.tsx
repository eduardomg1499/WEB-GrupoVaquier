    ...
    <footer className="bg-[#0a0a0a] py-12 border-t border-gray-dark/30">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex gap-6 text-sm text-silver/50">
          <a href="#" className="hover:text-terracotta transition-colors">Aviso de Privacidad</a>
          <a href="#" className="hover:text-terracotta transition-colors">Terminos y Condiciones</a>
        </div>
      </div>
    </footer>
  );
