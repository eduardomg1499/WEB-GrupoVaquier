  ...
  return (
    ...
    >
      <div className="relative flex items-center justify-center">
        <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" className="w-6 h-6 sm:w-7 sm:h-7">
      ...
      <span className="text-sm sm:text-base font-medium tracking-wide pr-1">WhatsApp</span>
    </motion.a>
  );
}
